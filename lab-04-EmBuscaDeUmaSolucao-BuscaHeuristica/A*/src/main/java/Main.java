...
public class Main {
    public static void main(String[] args){
        ...
        List<No> result = AStar.execute(arad, bucharest, h);
        assert result != null;
        for (No n : result)
            System.out.println(n);
        System.out.println();

        medirTempo(() -> AStar.execute(arad, bucharest, h));
        medirTempo(() -> AStar.execute(sibiu, bucharest, h));
        medirTempo(() -> AStar.execute(oradea, bucharest, h));
        medirTempo(() -> AStar.execute(timisoara, bucharest, h));
        medirTempo(() -> AStar.execute(zerind, bucharest, h));
        medirTempo(() -> AStar.execute(lugoj, bucharest, h));
        medirTempo(() -> AStar.execute(arad, bucharest, h));
        medirTempo(() -> AStar.execute(craiova, bucharest, h));
        medirTempo(() -> AStar.execute(mehadia, bucharest, h));
        medirTempo(() -> AStar.execute(giurgiu, bucharest, h));
